...
public class CraftPanel extends javax.swing.JPanel {
    ...
    public CraftPanel() {
        ...
        this.craftController = null; 

    }

    private void applyPrivileges() {
        // user = view only
        edit_btn.setVisible(isAdmin);
        del_btn.setVisible(isAdmin);

        // Save should only appear during admin editing
        save_btn.setVisible(false);

        edit_btn.setEnabled(isAdmin);
        del_btn.setEnabled(isAdmin);
        save_btn.setEnabled(isAdmin);
    }

    public CraftPanel(CraftController craftController, Craft craft, boolean isAdmin) {
        this(); // keep your existing init code
...
//    // <editor-fold defaultstate="collapsed" desc="Generated
   ...
   private void save_btnActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    String error = craftController.updateCraft(
            craft,
            name_txt.getText(),
            craft_txt.getText(),
            engine_txt.getText(),
            dep_time_txt.getText(),
    ...
    // Make fields read-only again (UI responsibility stays in View)
    craft_txt.setEditable(false);
    engine_txt.setEditable(false);
    flight_txt.setEditable(false);
    destination_txt.setEditable(false);
    ...
    if (choice == javax.swing.JOptionPane.YES_OPTION) {
        ...
        boolean removed = craftController.removeCraft(craft);

        if (removed) {
            javax.swing.JOptionPane.showMessageDialog(this, "Craft deleted successfully!");
